import JException.*;
/**
 * Fuções de view por JOptionPane;
 * 
...
public class EntradaJ implements IEntrada
{
    ...
    public String idadeAluno(){
        String i = JOptionPane.showInputDialog("Forneça a idade: ");
        return i;
    }
    ...
    public String notaAluno(){
        String nota = JOptionPane.showInputDialog("Forneça a nota: ");
        return nota;
    }
    ...
    public String listarMenu(String resp){
        String i = JOptionPane.showInputDialog(resp + "Escolha um aluno: ");
        return i;
    }
